...
const buildMessage = (sale: any) => (
  new Discord.MessageEmbed()
	...
	.setAuthor('MONAI Bot', 'https://files.readme.io/566c72b-opensea-logomark-full-colored.png', 'https://opensea.io/collection/monai')
	.setThumbnail('https://cdn.discordapp.com/attachments/884797247622103041/889564018359042058/Twitter_landscape_Copy_223.jpg')
	.addFields(
...
async function main() {
  ...
  const seconds = process.env.SECONDS ? parseInt(process.env.SECONDS) : 84600;
